...
public class ConfigReader {
	final static LoggerControler logger = LoggerControler.getLogger(ConfigReader.class);
	...
	private Properties getConfig(String propertyFileName) {
		...
		try {
			...
			properties = null;
			logger.info("FileNotFoundException:" + propertyFileName);
		} catch (IOException e) {
			properties = null;
			logger.info("IOException:" + propertyFileName);
		}
		return properties;
	}
}
